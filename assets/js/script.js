...
const slides = [
    './assets/img/angela-caroll-chief-editor.jpg', //0
    './assets/img/angela-lopez-social-media-manager.jpg', //1
    './assets/img/barbara-ramos-graphic-designer.jpg', //etc
...
function generateSlideCardMarkup(activeSlide, slide, index){
    ...
    return `
      <div class="my_bg_dark slide ${activeSlide === index ? 'active' : ''}">
        <img src="${slide.image}" alt="">
        <div class="slide-text my_bg_dark">
          <h3>${slide.title}</h3>
          <p>${slide.text}</p>
        </div>
      </div>
